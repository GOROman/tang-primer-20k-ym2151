...
add_file src/ddr_song_rom.v
add_file src/ddr_audio_store.v
add_file src/nlg_player.v
add_file src/uart_rx.v
add_file src/uart_tx.v
add_file src/xmodem_rx.v
add_file src/ddr_pll.v
add_file third_party/DDR3/ddr3_memory_interface.v
add_file src/dac_scale_test.v
add_file src/hdmi_opm_debug.v
add_file third_party/HDMI/dvi_tx/dvi_tx.v
add_file third_party/HDMI/gowin_rpll/TMDS_rPLL.v
add_file src/ddr_audio.cst
